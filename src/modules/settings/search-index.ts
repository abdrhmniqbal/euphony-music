...
export const SETTINGS_SEARCH_ENTRIES: SettingsSearchEntry[] = [
  ...
  { id: "advanced-search-history", route: "/settings/advanced", highlight: "resetSearchHistory", titleKey: "settings.advanced.resetSearchHistory", descriptionKey: "settings.advanced.resetSearchHistoryDescription", sectionKey: "settings.advanced.sections.history" },
  { id: "advanced-force-update-mixes", route: "/settings/advanced", highlight: "forceUpdateMixes", titleKey: "settings.advanced.forceUpdateMixes", descriptionKey: "settings.advanced.forceUpdateMixesDescription", sectionKey: "settings.advanced.sections.history" },
