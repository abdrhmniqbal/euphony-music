...
export const getTrackColors = async (imageUri: string): Promise<ColorPalette> => {
...
export const updateColorsForImage = async (imageUri: string | undefined) => {
    if (!imageUri) {
...
export const getCachedColors = (imageUri: string): ColorPalette | null => {
